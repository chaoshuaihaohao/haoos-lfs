...
BLFS_BUILD_PATH=$(readlink -f .)/blfs_build
CMD_PATH=$BLFS_BUILD_PATH/cmd
PKG_PATH=$BLFS_BUILD_PATH/pkg
#下载的源码包和patch的存放位置，需要在.cmd文件的上级目录
SRC_PATH=$BLFS_BUILD_PATH/cmd
